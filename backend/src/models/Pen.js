 ...
 */
// Pen.belongsTo(Lots, { foreignKey: 'lineType' })
// Pen.belongsTo(Lots, { foreignKey: 'lineNumber' })
// Pen.belongsTo(Lots, { foreignKey: 'source' })
// Pen.belongsTo(Lots, { foreignKey: 'lotId' })
// Pen.belongsTo(Lots, { foreignKey: 'birthday' })
