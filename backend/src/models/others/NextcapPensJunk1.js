...
/**
 * NextcapPensJunk1 Model
 * Table: nextcap_pens_junk1
 */
const NextcapPensJunk1 = sequelize.define('NextcapPensJunk1', {
  lineType: {
  ...
  tableName: 'nextcap_pens_junk1',
  timestamps: false, // 启用时间戳
  underscored: true, // 使用下划线命名
  comment: 'nextcap_pens_junk1 表',
})

export default NextcapPensJunk1
