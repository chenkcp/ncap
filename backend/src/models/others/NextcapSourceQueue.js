...
/**
 * NextcapSourceQueue Model
 * Table: NEXTCAP_SOURCE_QUEUE
 */
const NextcapSourceQueue = sequelize.define('NextcapSourceQueue', {
  queuePositionNr: {
  ...
  tableName: 'NEXTCAP_SOURCE_QUEUE',
  timestamps: false, // 启用时间戳
  underscored: true, // 使用下划线命名
  comment: 'NEXTCAP_SOURCE_QUEUE 表',
})

export default NextcapSourceQueue
