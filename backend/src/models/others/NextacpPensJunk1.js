...
/**
 * NextacpPensJunk1 Model
 * Table: nextacp_pens_junk1
 */
const NextacpPensJunk1 = sequelize.define('NextacpPensJunk1', {
  lineType: {
  ...
  tableName: 'nextacp_pens_junk1',
  timestamps: false, // 启用时间戳
  underscored: true, // 使用下划线命名
  comment: 'nextacp_pens_junk1 表',
})

export default NextacpPensJunk1
